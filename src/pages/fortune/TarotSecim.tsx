...
const TAROT_CARDS = [
  ...
  // Minor Arcana - Wands (22-32)
  { id: 22, name: 'Two of Wands', tr: 'Asalar İkili', suit: 'wands', image: '/images/tarot/minor-02-wands.jpg' },
  { id: 23, name: 'Three of Wands', tr: 'Asalar Üçlü', suit: 'wands', image: '/images/tarot/minor-03-wands.jpg' },
  { id: 24, name: 'Four of Wands', tr: 'Asalar Dörtlü', suit: 'wands', image: '/images/tarot/minor-04-wands.jpg' },
  { id: 25, name: 'Seven of Wands', tr: 'Asalar Yedili', suit: 'wands', image: '/images/tarot/minor-07-wands.jpg' },
  { id: 26, name: 'Eight of Wands', tr: 'Asalar Sekizli', suit: 'wands', image: '/images/tarot/minor-08-wands.jpg' },
  { id: 27, name: 'Nine of Wands', tr: 'Asalar Dokuzlu', suit: 'wands', image: '/images/tarot/minor-09-wands.jpg' },
  { id: 28, name: 'Ten of Wands', tr: 'Asalar Onlu', suit: 'wands', image: '/images/tarot/minor-10-wands.jpg' },
  { id: 29, name: 'Page of Wands', tr: 'Asalar Prensi', suit: 'wands', image: '/images/tarot/minor-page-wands.jpg' },
  { id: 30, name: 'Knight of Wands', tr: 'Asalar Şövalyesi', suit: 'wands', image: '/images/tarot/minor-knight-wands.jpg' },
  { id: 31, name: 'Queen of Wands', tr: 'Asalar Kraliçesi', suit: 'wands', image: '/images/tarot/minor-queen-wands.jpg' },
  { id: 32, name: 'King of Wands', tr: 'Asalar Kralı', suit: 'wands', image: '/images/tarot/minor-king-wands.jpg' },
  
  // Minor Arcana - Cups (33-46)
  { id: 33, name: 'Ace of Cups', tr: 'Kupalar As', suit: 'cups', image: '/images/tarot/minor-ace-cups.jpg' },
  { id: 34, name: 'Two of Cups', tr: 'Kupalar İkili', suit: 'cups', image: '/images/tarot/minor-02-cups.jpg' },
  { id: 35, name: 'Three of Cups', tr: 'Kupalar Üçlü', suit: 'cups', image: '/images/tarot/minor-03-cups.jpg' },
  { id: 36, name: 'Four of Cups', tr: 'Kupalar Dörtlü', suit: 'cups', image: '/images/tarot/minor-04-cups.jpg' },
  { id: 37, name: 'Five of Cups', tr: 'Kupalar Beşli', suit: 'cups', image: '/images/tarot/minor-05-cups.jpg' },
  { id: 38, name: 'Six of Cups', tr: 'Kupalar Altılı', suit: 'cups', image: '/images/tarot/minor-06-cups.jpg' },
  { id: 39, name: 'Seven of Cups', tr: 'Kupalar Yedili', suit: 'cups', image: '/images/tarot/minor-07-cups.jpg' },
  { id: 40, name: 'Eight of Cups', tr: 'Kupalar Sekizli', suit: 'cups', image: '/images/tarot/minor-08-cups.jpg' },
  { id: 41, name: 'Nine of Cups', tr: 'Kupalar Dokuzlu', suit: 'cups', image: '/images/tarot/minor-09-cups.jpg' },
  { id: 42, name: 'Ten of Cups', tr: 'Kupalar Onlu', suit: 'cups', image: '/images/tarot/minor-10-cups.jpg' },
  { id: 43, name: 'Page of Cups', tr: 'Kupalar Prensi', suit: 'cups', image: '/images/tarot/minor-page-cups.jpg' },
  { id: 44, name: 'Knight of Cups', tr: 'Kupalar Şövalyesi', suit: 'cups', image: '/images/tarot/minor-knight-cups.jpg' },
  { id: 45, name: 'Queen of Cups', tr: 'Kupalar Kraliçesi', suit: 'cups', image: '/images/tarot/minor-queen-cups.jpg' },
  { id: 46, name: 'King of Cups', tr: 'Kupalar Kralı', suit: 'cups', image: '/images/tarot/minor-king-cups.jpg' },
  
  // Minor Arcana - Swords (47-56)
  { id: 47, name: 'Ace of Swords', tr: 'Kılıçlar As', suit: 'swords', image: '/images/tarot/minor-ace-swords.jpg' },
  { id: 48, name: 'Two of Swords', tr: 'Kılıçlar İkili', suit: 'swords', image: '/images/tarot/minor-02-swords.jpg' },
  { id: 49, name: 'Three of Swords', tr: 'Kılıçlar Üçlü', suit: 'swords', image: '/images/tarot/minor-03-swords.jpg' },
  { id: 50, name: 'Four of Swords', tr: 'Kılıçlar Dörtlü', suit: 'swords', image: '/images/tarot/minor-04-swords.jpg' },
  { id: 51, name: 'Five of Swords', tr: 'Kılıçlar Beşli', suit: 'swords', image: '/images/tarot/minor-05-swords.jpg' },
  { id: 52, name: 'Six of Swords', tr: 'Kılıçlar Altılı', suit: 'swords', image: '/images/tarot/minor-06-swords.jpg' },
  { id: 53, name: 'Seven of Swords', tr: 'Kılıçlar Yedili', suit: 'swords', image: '/images/tarot/minor-07-swords.jpg' },
  { id: 54, name: 'Eight of Swords', tr: 'Kılıçlar Sekizli', suit: 'swords', image: '/images/tarot/minor-08-swords.jpg' },
  { id: 55, name: 'Nine of Swords', tr: 'Kılıçlar Dokuzlu', suit: 'swords', image: '/images/tarot/minor-09-swords.jpg' },
  { id: 56, name: 'Ten of Swords', tr: 'Kılıçlar Onlu', suit: 'swords', image: '/images/tarot/minor-10-swords.jpg' },
  
  // Minor Arcana - Pentacles (57-66)
  { id: 57, name: 'Five of Pentacles', tr: 'Tılsımlar Beşli', suit: 'pentacles', image: '/images/tarot/minor-05-pentacles.jpg' },
  { id: 58, name: 'Six of Pentacles', tr: 'Tılsımlar Altılı', suit: 'pentacles', image: '/images/tarot/minor-06-pentacles.jpg' },
  { id: 59, name: 'Seven of Pentacles', tr: 'Tılsımlar Yedili', suit: 'pentacles', image: '/images/tarot/minor-07-pentacles.jpg' },
  { id: 60, name: 'Eight of Pentacles', tr: 'Tılsımlar Sekizli', suit: 'pentacles', image: '/images/tarot/minor-08-pentacles.jpg' },
  { id: 61, name: 'Nine of Pentacles', tr: 'Tılsımlar Dokuzlu', suit: 'pentacles', image: '/images/tarot/minor-09-pentacles.jpg' },
  { id: 62, name: 'Ten of Pentacles', tr: 'Tılsımlar Onlu', suit: 'pentacles', image: '/images/tarot/minor-10-pentacles.jpg' },
  { id: 63, name: 'Page of Pentacles', tr: 'Tılsımlar Prensi', suit: 'pentacles', image: '/images/tarot/minor-page-pentacles.jpg' },
  { id: 64, name: 'Knight of Pentacles', tr: 'Tılsımlar Şövalyesi', suit: 'pentacles', image: '/images/tarot/minor-knight-pentacles.jpg' },
  { id: 65, name: 'Queen of Pentacles', tr: 'Tılsımlar Kraliçesi', suit: 'pentacles', image: '/images/tarot/minor-queen-pentacles.jpg' },
  { id: 66, name: 'King of Pentacles', tr: 'Tılsımlar Kralı', suit: 'pentacles', image: '/images/tarot/minor-king-pentacles.jpg' }
];
